...
const descriptionEn = `Hello, I'm <strong class="text-blue">Renato Lopes</strong>, a specialist in website development using CMS technologies such as Adobe Experience Manager (AEM), WordPress, Drupal, and handcoded (HTML, CSS, JS). I also work with web page globalization for small and large scale.`;
